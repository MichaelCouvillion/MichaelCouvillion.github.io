...
After visiting http://192.168.134.129 I was prompted to log in. I then went to the Applications tab, clicked create application, called it app and copied the token it created for me.
